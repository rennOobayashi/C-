...
namespace Week04Homework
{
    public partial class FormManager : Form
    {
        ...
        public FormManager()
        {
            ...
            {
                //ToString 없어도 됨, ONE, TWO, THREE, FOUR 추가됨
                //cmbYear.Items.Add(((YEAR)i).ToString());
                //cmbYear.Items.Add(i + 1);
            ...
            //    cmbYear.Items.Add(i);
            //}
            for (int i = 0; i < (int)CLASS.END; i++)
            {
                cmbYear.Items.Add(((CLASS)i));
            }
        ...
        private void RegisterStudent()
        {
            ...
            //열거형 = 정수
            //열거형 = (열거형)정수
            if ((YEAR)cmbYear.SelectedIndex < YEAR.END)
            {
