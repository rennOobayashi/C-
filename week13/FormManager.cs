...
namespace Week09Homework
{
    public partial class FormManager : Form
    {
        ...
        public FormManager()
        {
            ...
            OpenInfo(ref professors, DepartmentFullFileName);
            OpenInfo(ref students, DepartmentFullFileName);
        }
        ...
        private void btnRemoveDepartment_Click(object sender, EventArgs e)
        {
            ...
            if (lbxDepartment.SelectedItem is Department) {
                ...
                //var stuList = students.Select(m => m.Value.Dept.Code).Where(m => m == target.Code).ToList();
